...
/**
 * Simple benchmark runner for DataStax driver
 * Mimics the operations from QueryBench.php but uses DataStax driver API
 */

require __DIR__ . '/bootstrap.php';

class DataStaxQueryBench {
    private $session;

    public function __construct() {
        $this->session = DataStaxBenchEnv::session();
    }
...
// Run benchmarks
echo "=== DataStax PHP Driver Benchmarks ===\n";
echo 'PHP Version: ' . phpversion() . "\n";
echo 'DataStax Extension Version: ' . phpversion('cassandra') . "\n\n";

$bench = new DataStaxQueryBench();
...
echo "\n=== JSON Results ===\n";
echo json_encode(['driver' => 'datastax', 'results' => $results], JSON_PRETTY_PRINT) . "\n";
