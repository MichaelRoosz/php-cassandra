...
* Full name: `\Cassandra\Value\SetCollection`
...
```php
final public __construct(array $value, \Cassandra\TypeInfo\SetCollectionInfo $typeInfo): mixed
```
...
|-------------|-------------------------------------------|-------------|
| `$value`    | **array**                                 |             |
| `$typeInfo` | **\Cassandra\TypeInfo\SetCollectionInfo** |             |
