...
* Full name: `\Cassandra\Value\ListCollection`
...
```php
final public __construct(array $value, \Cassandra\TypeInfo\ListCollectionInfo $typeInfo): mixed
```
...
|-------------|--------------------------------------------|-------------|
| `$value`    | **array**                                  |             |
| `$typeInfo` | **\Cassandra\TypeInfo\ListCollectionInfo** |             |
...
```php
final public static fromValue(array $value, \Cassandra\Type|(array{type: \Cassandra\Type}&array) $valueDefinition, bool $isFrozen = false): static
```
