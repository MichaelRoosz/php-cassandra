...
* Full name: `\Cassandra\Value\Custom`
...
```php
final public __construct(string $value, \Cassandra\TypeInfo\CustomInfo $typeInfo): mixed
```
...
|-------------|------------------------------------|-------------|
| `$value`    | **string**                         |             |
| `$typeInfo` | **\Cassandra\TypeInfo\CustomInfo** |             |
...
```php
final public static fromValue(string $value, string $javaClassName): static
```
