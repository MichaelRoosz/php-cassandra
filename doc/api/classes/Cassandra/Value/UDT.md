...
```php
final public __construct(array $value, \Cassandra\TypeInfo\UDTInfo $typeInfo): mixed
```
...
|-------------|---------------------------------|-------------|
| `$value`    | **array**                       |             |
| `$typeInfo` | **\Cassandra\TypeInfo\UDTInfo** |             |
...
```php
final public static fromValue(array $value, array<string,\Cassandra\Type|(array{type: \Cassandra\Type}&array)> $valueDefinition, bool $isFrozen = false): static
```
...
|--------------------|-------------------------------------------------------------------------|-------------|
| `$value`           | **array**                                                               |             |
| `$valueDefinition` | **array<string,\Cassandra\Type\|(array{type: \Cassandra\Type}&array)>** |             |
| `$isFrozen`        | **bool**                                                                |             |
