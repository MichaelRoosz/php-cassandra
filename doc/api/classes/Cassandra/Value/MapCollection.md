...
* Full name: `\Cassandra\Value\MapCollection`
...
```php
final public __construct(array $value, \Cassandra\TypeInfo\MapCollectionInfo $typeInfo): mixed
```
...
|-------------|-------------------------------------------|-------------|
| `$value`    | **array**                                 |             |
| `$typeInfo` | **\Cassandra\TypeInfo\MapCollectionInfo** |             |
...
```php
final public static fromValue(array $value, \Cassandra\Type|(array{type: \Cassandra\Type}&array) $keyDefinition, \Cassandra\Type|(array{type: \Cassandra\Type}&array) $valueDefinition, bool $isFrozen = false): static
```
...
|--------------------|-----------------------------------------------------------|-------------|
| `$value`           | **array**                                                 |             |
| `$keyDefinition`   | **\Cassandra\Type\|(array{type: \Cassandra\Type}&array)** |             |
| `$valueDefinition` | **\Cassandra\Type\|(array{type: \Cassandra\Type}&array)** |             |
| `$isFrozen`        | **bool**                                                  |             |
