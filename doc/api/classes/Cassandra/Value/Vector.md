...
* Full name: `\Cassandra\Value\Vector`
...
```php
final public __construct(array $value, \Cassandra\TypeInfo\VectorInfo $typeInfo): mixed
```
...
|-------------|------------------------------------|-------------|
| `$value`    | **array**                          |             |
| `$typeInfo` | **\Cassandra\TypeInfo\VectorInfo** |             |
...
```php
final public static fromValue(array $value, \Cassandra\Type|(array{type: \Cassandra\Type}&array) $valueDefinition, int $dimensions): static
```
