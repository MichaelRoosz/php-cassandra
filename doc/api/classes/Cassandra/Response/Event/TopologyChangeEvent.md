...
* Full name: `\Cassandra\Response\Event\TopologyChangeEvent`
* Parent class: [`\Cassandra\Response\Event`](../Event.md)
...
```php
public getData(): \Cassandra\Response\Event\Data\EventData
```

***

### getTopologyChangeData

```php
public getTopologyChangeData(): \Cassandra\Response\Event\Data\TopologyChangeData
```
...
```php
public static getEventClassMap(): array<string,class-string<\Cassandra\Response\Event>>
```
...
```php
public getType(): \Cassandra\EventType
```
