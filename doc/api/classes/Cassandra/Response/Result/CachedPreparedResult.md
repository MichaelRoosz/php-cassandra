# CachedPreparedResult

***

* Full name: `\Cassandra\Response\Result\CachedPreparedResult`
* Parent class: [`\Cassandra\Response\Result\PreparedResult`](./PreparedResult.md)
...
```php
final public __construct(\Cassandra\Protocol\Header $header, \Cassandra\Response\StreamReader $stream, ?\Cassandra\Response\Result\Data\PreparedData $preparedData = null): mixed
```
...
| `$preparedData` | **?\Cassandra\Response\Result\Data\PreparedData** |             |
...
```php
public getPreparedData(): \Cassandra\Response\Result\Data\PreparedData
```
