...
* Full name: `\Cassandra\Response\ProgressiveStreamReader`
* Parent class: [`\Cassandra\Response\StreamReader`](./StreamReader.md)
...
```php
public setSource(\Cassandra\Connection\Node $source): void
```
...
| Parameter | Type                           | Description |
|-----------|--------------------------------|-------------|
| `$source` | **\Cassandra\Connection\Node** |             |
