...
* Full name: `\Cassandra\TypeInfo\ListCollectionInfo`
...
```php
public static fromTypeDefinition(array{type: \Cassandra\Type::LIST, valueType: \Cassandra\Type|(array{type: \Cassandra\Type}&array), isFrozen: bool} $typeDefinition): self
```
...
| Parameter         | Type                                                                                                                     | Description |
|-------------------|--------------------------------------------------------------------------------------------------------------------------|-------------|
| `$typeDefinition` | **array{type: \Cassandra\Type::LIST, valueType: \Cassandra\Type\|(array{type: \Cassandra\Type}&array), isFrozen: bool}** |             |
