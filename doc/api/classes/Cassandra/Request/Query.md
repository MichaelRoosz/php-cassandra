...
* Full name: `\Cassandra\Request\Query`
...
```php
public __construct(string $query, array $values = [], \Cassandra\Consistency $consistency = \Cassandra\Consistency::ONE, \Cassandra\Request\Options\QueryOptions $options = new \Cassandra\Request\Options\QueryOptions()): mixed
```
...
```php
public getOptions(): \Cassandra\Request\Options\QueryOptions
```
