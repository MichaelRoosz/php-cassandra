...
enum ExceptionCode: int {
    ...
    case COMPRESSION_OUTPUT_OVERFLOW = 1400;
    case COMPRESSION_OUTPUT_UNDERFLOW = 1080;

    // ConnectionException - (CONNECTION_)
    case CONNECTION_AUTH_CHALLENGE_UNSUPPORTED = 1353;
    case CONNECTION_AUTH_FAILED = 1005;
    case CONNECTION_AUTH_MISSING_CREDENTIALS = 1007;
    case CONNECTION_AUTO_PREPARE_ORIGINAL_NOT_QUERY = 1303;
    ...
    case CONNECTION_PROTOCOL_VERSION_MISMATCH = 1016;
    case CONNECTION_QUERY_UNEXPECTED_RESPONSE = 1017;
    case CONNECTION_REPREPARATION_LIMIT_REACHED = 1351;
    case CONNECTION_REPREPARATION_UNEXPECTED_RESPONSE = 1019;
    case CONNECTION_REPREPARE_BATCH_STATEMENT_NOT_REPLACED = 1363;
    case CONNECTION_REPREPARE_ORIGINAL_NOT_EXECUTE = 1020;
    case CONNECTION_REPREPARE_UNEXPECTED_RESPONSE_REBATCH = 1364;
    case CONNECTION_REPREPARE_UNEXPECTED_RESPONSE_REEXECUTE = 1021;
    case CONNECTION_REPREPARE_UNEXPECTED_RESULT_TYPE = 1022;
    case CONNECTION_RESPONSE_BODY_TOO_LARGE = 1355;
    case CONNECTION_RESPONSE_STREAM_ID_INVALID = 1419;
    case CONNECTION_RESPONSE_STREAM_NOT_OUTSTANDING = 1420;
    ...
    case CONNECTION_STATEMENT_NO_LONGER_RESOLVABLE = 1346;
    case CONNECTION_STREAM_ID_ALREADY_IN_USE = 1305;
    case CONNECTION_SYNC_NULL_RESPONSE = 1026;
    case CONNECTION_TOO_MANY_ORPHANED_STREAMS = 1343;
    case CONNECTION_UNABLE_TO_CONNECT_ANY_NODE = 1027;
    case CONNECTION_UNEXPECTED_RESPONSE_BATCH_SYNC = 1028;
    case CONNECTION_UNKNOWN_ERROR_CODE = 1029;
    case CONNECTION_UNKNOWN_EVENT_TYPE = 1030;
    case CONNECTION_UNKNOWN_RESPONSE_TYPE = 1031;
    case CONNECTION_UNKNOWN_RESULT_KIND = 1032;
    case CONNECTION_UNPREPARED_BATCH_STATEMENT_NOT_FOUND = 1362;
    case CONNECTION_UNPREPARED_PREV_NO_REQUEST = 1033;
    case CONNECTION_UNPREPARED_PREV_NOT_PREPARE_REQUEST = 1034;
    case CONNECTION_UNPREPARED_UNEXPECTED_PREV_RESULT_TYPE = 1035;
    case CONNECTION_WAIT_CONNECTION_REPLACED = 1357;
    ...
    case REQUEST_FRAME_BODY_TOO_LARGE = 1396;
    case REQUEST_INVALID_CUSTOM_PAYLOAD = 1375;
    case REQUEST_INVALID_DEFAULT_TIMESTAMP = 1412;
    case REQUEST_INVALID_FLAGS = 1397;
    case REQUEST_INVALID_NOW_IN_SECONDS = 1399;
    case REQUEST_INVALID_PAGE_SIZE = 1390;
    case REQUEST_INVALID_REGISTER_EVENT = 1386;
    case REQUEST_INVALID_REQUEST_TIMEOUT = 1349;
    case REQUEST_INVALID_STARTUP_OPTION = 1385;
    case REQUEST_INVALID_STREAM_ID = 1398;
    case REQUEST_STREAM_NOT_ASSIGNED = 1342;
    case REQUEST_TOO_MANY_MAP_ENTRIES = 1372;
    case REQUEST_TOO_MANY_REGISTER_EVENTS = 1421;
    ...
    case REQUEST_VALUES_DUPLICATE_BIND_MARKER = 1332;
    case REQUEST_VALUES_EXTRA_BIND_VALUE = 1370;
    ...
    // RequestTimeoutException (REQUESTTIMEOUT_)
    case REQUESTTIMEOUT_STREAM_IDS_EXHAUSTED = 1354;
    case REQUESTTIMEOUT_WAITING_FOR_RESPONSE = 1338;
    case REQUESTTIMEOUT_WAITING_FOR_STATEMENTS = 1339;

    // ResponseException (RESPONSE_)
    case RESPONSE_DECODE_FAILED = 1438;
    case RESPONSE_ERROR_CONTEXT_INVALID_TYPE = 1310;
    ...
    case RESPONSE_ROWS_INVALID_COLUMN_INDEX = 1359;
    ...
    case RESPONSE_SR_DUPLICATE_UDT_FIELD = 1430;
    case RESPONSE_SR_INET_PARSE_FAIL = 1120;
    case RESPONSE_SR_INVALID_COLLECTION_COUNT = 1373;
    ...
    case RESPONSE_SR_INVALID_OFFSET = 1379;
    case RESPONSE_SR_INVALID_REASON_MAP_COUNT = 1374;
    ...
    case RESPONSE_SR_UNPACK_DOUBLE_FAIL = 1325;
    case RESPONSE_SR_UNPACK_FLOAT_FAIL = 1326;
    ...
    case RESPONSE_SR_VALUE_LENGTH_MISMATCH = 1327;
    ...
    // SocketException (SOCKET_)
    case SOCKET_CONNECT_FAILED = 1037;
    case SOCKET_CREATE_FAILED = 1038;
    case SOCKET_EXTENSION_NOT_LOADED = 1426;
    case SOCKET_HOST_RESOLUTION_FAILED = 1337;
    case SOCKET_INVALID_CONFIG = 1039;
    case SOCKET_NOT_CONNECTED_DURING_READ = 1040;
    ...
    case SOCKET_SET_OPTION_FAILED = 1388;
    ...
    case STATEMENT_ABANDONED = 1341;
    case STATEMENT_INVALID_LIST_ENTRY = 1387;
    case STATEMENT_NOT_ON_THIS_CONNECTION = 1345;
    case STATEMENT_UNEXPECTED_PREPARED_RESULT = 1000;
    case STATEMENT_UNEXPECTED_RESULT = 1001;
    case STATEMENT_UNEXPECTED_ROWS_RESULT = 1002;
    case STATEMENT_UNEXPECTED_SCHEMA_CHANGE_RESULT = 1003;
    case STATEMENT_UNEXPECTED_SET_KEYSPACE_RESULT = 1004;

    // StreamException (STREAM_)
    case STREAM_CONNECT_FAILED = 1050;
    case STREAM_INVALID_CONFIG = 1051;
    case STREAM_NOT_CONNECTED_DURING_READ = 1052;
    case STREAM_NOT_CONNECTED_DURING_WRITE = 1054;
    ...
    case STREAM_SET_TIMEOUT_FAILED = 1389;
    ...
    case TYPEINFO_INVALID_IS_FROZEN = 1427;
    ...
    case TYPEINFO_UDT_INVALID_KEYSPACE = 1428;
    case TYPEINFO_UDT_INVALID_NAME = 1429;
    case TYPEINFO_UDT_INVALID_TYPE = 1247;
    case TYPEINFO_UDT_INVALID_VALUETYPE = 1381;
    ...
    case TYPENAMEPARSER_INVALID_PARAM_BRACKETS_UNMATCHED_CLOSING = 1275;
    case TYPENAMEPARSER_INVALID_PARAM_BRACKETS_UNMATCHED_OPENING = 1276;
    case TYPENAMEPARSER_LIST_INVALID_PARAM_COUNT = 1277;
    case TYPENAMEPARSER_MAP_INVALID_PARAM_COUNT = 1278;
    case TYPENAMEPARSER_NESTING_TOO_DEEP = 1361;
    case TYPENAMEPARSER_REVERSED_INVALID_PARAM_COUNT = 1279;
    case TYPENAMEPARSER_SET_INVALID_PARAM_COUNT = 1280;
    case TYPENAMEPARSER_SIMPLE_TYPE_CANNOT_BE_FROZEN = 1281;
    case TYPENAMEPARSER_SIMPLE_TYPE_WITH_PARAMETERS = 1282;
    case TYPENAMEPARSER_TUPLE_INVALID_PARAM_COUNT = 1283;
    case TYPENAMEPARSER_UDT_DUPLICATE_FIELD = 1431;
    case TYPENAMEPARSER_UDT_FIELD_KEY_NOT_STRING = 1284;
    case TYPENAMEPARSER_UDT_INVALID_PARAM_COUNT = 1285;
    case TYPENAMEPARSER_UDT_NAME_INVALID_HEX = 1336;
    case TYPENAMEPARSER_UDT_PARAMS_MULTIPLE_COLONS = 1286;
    case TYPENAMEPARSER_VECTOR_DIMENSIONS_NON_NUMERIC = 1287;
    case TYPENAMEPARSER_VECTOR_DIMENSIONS_NOT_INTEGER = 1413;
    case TYPENAMEPARSER_VECTOR_DIMENSIONS_OUT_OF_RANGE = 1288;
    ...
    case VALUE_COMPARATOR_INVALID_LENGTH = 1424;
    case VALUE_COMPARATOR_TRUNCATED_BINARY = 1425;
    ...
    case VALUE_DECIMAL_SCALE_OUT_OF_RANGE = 1335;
    case VALUE_DECIMAL_UNPACK_FAILED = 1168;
    case VALUE_DECIMAL_UNSCALED_TOO_LARGE = 1423;
    ...
    case VALUE_DURATION_NANOSECONDS_OUT_OF_RANGE = 1432;
    ...
    case VALUE_INET_INVALID_ADDRESS = 1434;
    ...
    case VALUE_MAP_CANNOT_CONVERT_TO_ARRAY = 1415;
    case VALUE_MAP_DUPLICATE_KEY = 1410;
    ...
    case VALUE_SET_DUPLICATE_ELEMENT = 1411;
    ...
    case VALUE_TIMESTAMP_OUT_OF_RANGE = 1391;
    ...
    case VALUE_TUPLE_UNDECLARED_VALUE = 1382;
    ...
    case VALUE_VECTOR_TRUNCATED_VALUE = 1433;
    case VALUE_VECTOR_TYPEINFO_REQUIRED = 1264;

    // ValueFactoryException (VALUEFACTORY_)
    case VALUEFACTORY_CANNOT_GET_TYPE_OBJECT_FOR_VALUE = 1182;
    case VALUEFACTORY_CLASS_UNKNOWN_DATA_TYPE = 1183;
    case VALUEFACTORY_COMPLEX_TYPEINFO_REQUIRED = 1184;
    case VALUEFACTORY_TYPEDEF_INVALID_NESTED_DEFINITION = 1395;
