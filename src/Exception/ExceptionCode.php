...
enum ExceptionCode: int {
    ...
    // RequestTimeoutException uses the REQUEST_TIMEOUT_ prefix
    case REQUEST_TIMEOUT_WAITING_FOR_RESPONSE = 1338;
    case REQUEST_TIMEOUT_WAITING_FOR_STATEMENTS = 1339;
