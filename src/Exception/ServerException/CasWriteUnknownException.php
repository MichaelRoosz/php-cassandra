...
final class CasWriteUnknownException extends ServerException {
    /**
     * @throws \Cassandra\Exception\ResponseException
     */
    #[\Override]
    public function getErrorContext(): CasWriteUnknownContext {

        if (!$this->errorContext instanceof CasWriteUnknownContext) {
            throw new ResponseException(
                'Error context is not a CasWriteUnknownContext',
